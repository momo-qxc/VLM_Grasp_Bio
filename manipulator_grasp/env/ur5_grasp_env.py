...
class UR5GraspEnv:
    ...
    def render(self, camera_name=None):
        ...
        camera_name: 可选，指定使用的相机名称。默认使用 self.camera_name。
        '''
        # 动态获取相机 ID
        ...
        # 更新渲染器中的场景数据
        self.mj_renderer.update_scene(self.mj_data, cam_id)
        self.mj_depth_renderer.update_scene(self.mj_data, cam_id)
        # 渲染图像和深度图
        return {
